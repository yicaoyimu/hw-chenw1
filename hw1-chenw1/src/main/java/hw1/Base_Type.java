...
public class Base_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("hw1.Base");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "hw1.Base");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "hw1.Base");
